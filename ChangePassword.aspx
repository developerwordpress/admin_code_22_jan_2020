<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ChangePassword.aspx.vb" Inherits="Dashboard2" %>
...
<td>
    ...
    <asp:TextBox ID="TextBox4" runat="server"  Width="250" Height="50" TextMode="Password"></asp:TextBox>
</td>
</tr>
...
<td>
    ...
    <asp:TextBox ID="TextBox3" runat="server"  Width="250" Height="50" TextMode="Password"></asp:TextBox>
</td>
</tr>
<tr>
<td style="height: 30px">
...
<tr>
<td align ="center">
 <asp:Button ID="Button1" runat="server" Text="Update" Width="250" Height="50" ForeColor="White"
