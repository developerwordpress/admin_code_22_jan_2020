<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Pricing.aspx.vb" Inherits="Dashboard2" %>
                        ...
                        <div class="col-lg-8 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                            <asp:Button ID="Button6" runat="server" Text="Rate Overide" Width="150" Height="35" ForeColor="White"
...
<td>
    ...
    <asp:DropDownList ID="DropDownList3" runat="server" Width="250" Height="50">
    <asp:ListItem>-select-</asp:ListItem>
     </asp:DropDownList>
...
<tr>
<td>
 <asp:TextBox ID="TextBox8" runat="server"  Width="250" Height="50"  placeholder="   County Name"  Visible="false" ></asp:TextBox>
...
<td>
    ...
    <asp:TextBox ID="TextBox7" runat="server"  Width="287" Height="50" placeholder="     mandatory"></asp:TextBox>
    <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" Text="Update Gap Only"></asp:CheckBox>
</td>
</tr>
...
<td align ="center">
 <asp:Button ID="Button1" runat="server" Text="Save" Width="305" Height="50" ForeColor="White"
      ...
      <center>
         ...
         <td>
         <asp:DropDownList ID="DropDownList4" runat="server" Width="287" Height="30">
         ...
         <td>
         <asp:TextBox ID="TextBox9" runat="server" Width="287" Height="30"></asp:TextBox>
         </td>
         <td>
         ...
         <br />
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" 
            EmptyDataText="No data" DataKeyNames="id2" AllowPaging="true"
             OnPageIndexChanging="OnPageIndexChanging" onrowcancelingedit="GridView1_RowCancelingEdit"   
              onrowediting="GridView1_RowEditing" OnRowUpdating="OnRowUpdating" PageSize="10">
             <Columns >
             
               
                   <asp:TemplateField Visible ="false">
                <ItemTemplate>
                    <asp:Label ID="Label11" runat="server" Text='<%# Eval("id2")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
             
                <asp:BoundField DataField="id2" HeaderText="Sl No." HeaderStyle-Width="45" FooterStyle-Width="45" ItemStyle-HorizontalAlign="NotSet" />   
          ...
          <asp:BoundField DataField="state" HeaderText="State" HeaderStyle-Width="150" FooterStyle-Width="150" ItemStyle-HorizontalAlign="NotSet" />   
                    ...
                    <%--<asp:BoundField DataField="rate" HeaderText="Rate" HeaderStyle-Width="150" FooterStyle-Width="150" ItemStyle-HorizontalAlign="NotSet" />--%>   
                         ...
                         <asp:TemplateField HeaderText="Rate" ItemStyle-Width="70">
                    <ItemTemplate>
                        <asp:Label ID="lblrate" runat="server" Text='<%# Eval("rate")%>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                         <asp:TextBox ID="txtrate" runat="server" Width="60" Text='<%# Eval("rate")%>'></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderText="Gap Rate" ItemStyle-Width="70">
                    <ItemTemplate>
                        <asp:Label ID="lblgap_rate" runat="server" Text='<%# Eval("gap_rate")%>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                         <asp:TextBox ID="txtgaprate" runat="server" Width="60" Text='<%# Eval("gap_rate")%>'></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
            ...
            OnClientClick="return confirm('Are you sure you want to delete this user ?')"
             CausesValidation="false" CommandArgument = '<%# Eval("id2") %>' 
    ...
    <ItemTemplate >
        <asp:Label ID="txtslno" runat="server" Text='<%#Eval("id2") %>' Visible="false"/>
    </ItemTemplate>
     </asp:TemplateField>
