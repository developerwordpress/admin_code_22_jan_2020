...
Partial Class Dashboard2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            con.Open()
            Dim cmd0 As New SqlCommand("select distinct id,Firstname+' '+Lastname as emp_fullname from UserMaster order by emp_fullname", con)
            Dim rd0 As New SqlDataAdapter(cmd0)
            Dim dt0 As New DataTable()
            rd0.Fill(dt0)
            DropDownList3.DataSource = dt0
            DropDownList3.DataTextField = "emp_fullname"
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Not DropDownList3.Text = "-select" And Not DropDownList1.Text = "-select" And Not DropDownList2.Text = "-select-" And TextBox1.Text <> "" And _
        TextBox4.Text <> "" And TextBox7.Text <> "" Then

            con.Open()
            Dim cmd2 As New SqlCommand
            cmd2.Connection = con
            cmd2.CommandText = "insert into user_override_search_rate (user_id,search_type,state,rate,gap_rate,created_by,created_on,updated_by,updated_on,county) values('" & _
            DropDownList3.Text & "','" & _
            TextBox1.Text & "','" & DropDownList1.Text & "','" & TextBox4.Text & "','" & TextBox7.Text & "','" & _
            sessionnnn.Text & "','" & Now.Date & "','" & sessionnnn.Text & "','" & Now.Date & "','" & DropDownList4.Text & "')"
    ...
    Protected Sub DropDownList1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownList1.SelectedIndexChanged
        ...
        DropDownList4.DataTextField = "COUNTY"
        DropDownList4.DataValueField = "COUNTY"
    ...
    Protected Sub DropDownList2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownList2.SelectedIndexChanged
        ...
        cmd3.CommandText = "select id from options where name = '" & _
                DropDownList2.Text & "' and option_id like '" & "2" & "'"
        cmd3.Connection = con
        ...
        con.Open()
        'Dim cmd3 As New SqlCommand
        cmd3.CommandText = "select * from search_rate where search_type = '" & _
                TextBox1.Text & "' and state = '" & DropDownList1.Text & _
                "' and county='" & DropDownList4.Text & "'"
        cmd3.Connection = con
        'Dim dr1 As SqlDataReader
        dr1 = cmd3.ExecuteReader
        ...
        If dr1.HasRows Then
            dr1.Read()
            TextBox4.Text = dr1.Item("rate")
            TextBox7.Text = dr1.Item("gap_rate")
            dr1.Close()
        End If
        con.Close()
    ...
    Protected Sub shad()
        ...
        If TextBox10.Text = "" Then
            con.Open()
            Dim cmd5 As New SqlCommand("select * from user_override_search_rateq where option_id='" & "2" & "' order by override_id desc", con)
        ...
        If TextBox10.Text <> "" Then
            con.Open()
            Dim cmd5 As New SqlCommand("select * from user_override_search_rateq where option_id='" & "2" & "' and " & DropDownList5.Text & "  like '%" & TextBox10.Text & "%' order by override_id desc", con)
            Dim da5 As New SqlDataAdapter(cmd5)
            Dim ds5 As New DataSet
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        rs.Connection = con
        rs.CommandText = "delete from user_override_search_rate where override_id like '" & txtslno.Text & "'"
        rs.ExecuteNonQuery()
        con.Close()
        shad()
    End Sub
    ...
    Protected Sub DropDownList3_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownList3.SelectedIndexChanged
        ...
        If dr1.HasRows Then
            dr1.Read()
            Label1.Text = dr1.Item("firstname") + " " + dr1.Item("lastname")
            dr1.Close()
        End If
        con.Close()
    ...
    Protected Sub Button9_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button9.Click
        On Error Resume Next
        con.Open()
        Dim cmd5 As New SqlCommand("select * from user_override_search_rateq where " & DropDownList5.Text & "  like '%" & TextBox10.Text & "%' order by override_id desc", con)
        Dim da5 As New SqlDataAdapter(cmd5)
        Dim ds5 As New DataSet
