...
Partial Class Dashboard2
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        TextBox3.Text <> "" And TextBox4.Text <> "" And TextBox3.Text = TextBox2.Text Then
        
            con.Open()
            cmd = New SqlCommand
            cmd.Connection = con
            cmd.CommandText = "update Admin_Screen_Allotment set user_password='" & _
            TextBox3.Text & "' where  user_id='" & TextBox1.Text & "' and user_password='" & TextBox4.Text & "'"
            cmd.ExecuteNonQuery()
            con.Close()
            ...
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "err_msg", "alert('" + "Password updated...!" + "');", True)
